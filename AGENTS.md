...
เมื่อผู้ใช้บอกว่า **"จดจำข้อมูลทั้งหมด"** หรือ **"บันทึกข้อมูลทั้งหมด"** ให้อัปเดตข้อมูลที่เกี่ยวข้องลงในทั้ง 4 ไฟล์นี้ โดยรักษาบทบาทของแต่ละไฟล์: กฎถาวรใน `CLAUDE.md`/`AGENTS.md`, ประวัติและเหตุผลใน `CONTEXT.md`, และสถานะล่าสุดใน `HANDOFF.md`
