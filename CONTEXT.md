...
กติกานี้ใช้กับ Claude, Claude Code, Codex และ AI อื่นทุกตัวที่รองรับ Mem0/MCP โดย AI เหล่านั้นต้องรับทราบว่า Mem0 เป็นความจำข้าม AI และควรอ่านหรือค้นร่วมกับไฟล์ทั้ง 4 ก่อนทำงานเมื่อจำเป็น
